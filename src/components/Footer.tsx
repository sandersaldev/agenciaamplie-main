...
const Footer = () => {
  ...
  const footerLinks = {
    Empresa: ["Sobre", "Serviços", "Portfólio", "Blog"],
    Serviços: ["Design", "Desenvolvimento", "Marketing", "Consultoria"],
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="w-10 h-10 rounded-lg bg-muted hover:bg-primary/20 border border-border/50 hover:border-primary/50 flex items-center justify-center transition-all hover:scale-110"
                  >
